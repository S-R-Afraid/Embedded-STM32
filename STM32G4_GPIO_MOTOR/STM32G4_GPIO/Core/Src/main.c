...
uint8_t DataB1[32]="LED1 T";
uint8_t DataB2[32]="LED2 T";
uint8_t DataB3[32]="LED1&LED2 OPEN";
...
void HAL_GPIO_EXIT_Callback(uint16_t GPIO_Pin){
    ...
    if(Button2_Pin == GPIO_Pin)
    {
        ...
        while(HAL_DMA_GetState(&hdma_usart3_tx) != HAL_DMA_STATE_READY);
        HAL_UART_Transmit_DMA(&huart3,DataB2,sizeof(DataB2));
    }
...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart)
{
  ...
  {
      RxBuffer[Uartl_Rx_Cnt++] = aRxBuffer;
  }
  HAL_UART_Receive_IT(&huart3,(uint8_t *)&aRxBuffer,1);
}
...
void HAL_ADCEx_InjectedConvCpltCallback(ADC_HandleTypeDef *hadc)
{
    ...
    if(hadc == &hadc2)
    {
        temp[3] = hadc2.Instance->JDR1;
        temp[3] = (temp[3] - 0x7e8)*0.02917f;
    }
}
/* USER CODE END 4 */
