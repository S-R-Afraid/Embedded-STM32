...
void TIM6_IRQHandler(void)
{
    ...
    lcd_draw_rectangle(180,400,220,440,WHITE);
    lcd_fill_circle(200+cx,420+cy,5,WHITE);
...
void TIM7_IRQHandler(void)
{
    ...
    sand_clock();
    float v = (float)block1.snum/SAND_NUM;
    
    lcd_fill(7,7,23,348,BLACK);
    if(v>0.8){
        lcd_fill(7,7,23,348*v,WHITE);
    }
    else if(v<0.8&&v>0.5){
        lcd_fill(7,7,23,348*v,GREEN);
    }
    else if(v<0.5&&v>0.2){
