...
//            int OLED_x = PS2_x_f * 64;
//            int OLED_y = PS2_y_f * 64;
//            OLED_Clear();
//            DrawBoard();
//            OLED_DrawCircle(OLED_x,OLED_y,5,1);
//            OLED_Printf(0,0,OLED_6X8,"x: %d,y: %d",PS2_xy_value[0],PS2_xy_value[1]);
        ...
        if(PS2_y_f > 0.2){//y向下
            if(PS2_x_f > PS2_y_f || PS2_x_f < -PS2_y_f){
